...
public class LocalWorker implements SocketServer1To1.MessageCallback {
	static final String  TAG = "LocalWorker";

	static private SocketServer1To1 masterSocketServer;

	static private WorkerProcessMonitorThread workerProcessMonitorThread;

	private LocalWorker(int p) {
	...
	public static void main(String[] args) {
		if (args.length >= 1) {
			...
			LocalWorker worker = new LocalWorker(port);
	...
	public static void runProcessFromString(String s) {
		try
		{
